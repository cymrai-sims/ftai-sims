...
const notificationData = [
  {
    ...
    value: "1,240",
    change: "+2.7%",
    icon: <HiUsers className="text-[var(--blue-main)] text-3xl" />,
  },
  {
    ...
    change: "-0.5%",
    icon: (
      <RiCustomerService2Line className="text-[var(--blue-main)] text-3xl" />
    ),
  },
  {
    title: "Orders",
    value: "320",
    change: "+1.2%",
    icon: <IoReceipt className="text-[var(--blue-main)] text-3xl" />,
  },
  {
    title: "Revenue",
    value: "$12,000",
    change: "+4.8%",
    icon: <FaMoneyBills className="text-[var(--blue-main)] text-3xl" />,
  },
];
...
const Dashboard = () => {
  ...
  const inventoryValueColors = [
    getComputedStyle(document.documentElement)
      .getPropertyValue("--dark-main")
      .trim(),
    getComputedStyle(document.documentElement)
      .getPropertyValue("--blue-main")
      .trim(),
    getComputedStyle(document.documentElement)
      .getPropertyValue("--orange-main")
      .trim(),
  ];
